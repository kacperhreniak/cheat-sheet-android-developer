...
### **sealed class** - [more](https://kotlinlang.org/docs/sealed-classes.html)
```
...
### **Field** - [more](https://kotlinlang.org/docs/properties.html#backing-fields)
```
...
### **Lambda expression** - [more](https://kotlinlang.org/docs/lambdas.html#lambda-expressions-and-anonymous-functions)
```
...
### **Enumerate: scope functions** - [more](https://kotlinlang.org/docs/scope-functions.html)
```
...
### **Kotlin: delegation** - [more](https://kotlinlang.org/docs/delegation.html)
```
...
### **backing field** - [more](https://kotlinlang.org/docs/properties.html#backing-fields)
```
...
```
Group of dalagates avaiabale by default in Kotlin langauge: lazy(), observable(), delegate to other property
```
...
### **internal visibility modifier** - [more](https://kotlinlang.org/docs/visibility-modifiers.html)
```
...
### **StateFlow** - [more](https://developer.android.com/kotlin/flow/stateflow-and-sharedflow)
```
...
### **SharedFlow** - [more](https://developer.android.com/kotlin/flow/stateflow-and-sharedflow)
```
...
### **Flow or StateFlow or SharedFlow: show snackbar**
```
...
```
### **Flow or StateFlow or SharedFlow: data store**
```
